...
const (
	InsertUrlQuery = "INSERT INTO tinyurl (short_url, long_url, created_at) VALUES(?, ?, ?)"
	GetUrlQuery    = "SELECT long_url FROM tinyurl WHERE short_url = ? LIMIT 1"
)
...
func (d *Database) InsertUrl(ctx context.Context, shortUrl string, longUrl string) error {
